...
cfg0 = {
    "public": {"forces": {"anchor.spring": {"enable": True, "k_local": 1.0}, "ll.disk": {"enable": True, "k_ll_repulse": 1.0}}}
}
cfgw = {
    "public": {"forces": {"anchor.spring": {"enable": True, "k_local": 2.0}, "ll.disk": {"enable": True, "k_ll_repulse": 1.0}}}
}
